...
public class DefaultParams {
    ...
    public static String SEARCH_CITY_DF_NAMEREQUIRED = "true";
    public static String SEARCH_CITY_DF_STYLE = "FULL";
    public static String SEARCH_CITY_DF_USERNAME = "ilgeonamessample";
}
